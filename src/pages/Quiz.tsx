...
const Quiz = () => {
  ...
  const questions: Question[] = [
    ...
    {
      question: "Որ քաղաքից մեկնեց դա Գաման իր առաջին ճամփորդության համար?",
      options: ["Պորտո", "Լիսաբոն", "Սինեշ", "Ֆարո"],
      correctAnswer: 1
    },
    {
      question: "Ինչ կոչվում էր դա Գամայի հիմնական նավը?",
      options: ["Սանտա Մարիա", "Սան Գաբրիել", "Վիկտորիա", "Նինա"],
      correctAnswer: 1
    },
    {
      question: "Որ ծովանցը շրջանցեց դա Գաման դեպի Հնդկաստան ճանապարհին?",
      options: ["Սուեզի ծովանց", "Հուսո հրվանդան", "Հորնի հրվանդան", "Մագելանի ծիղ"],
      correctAnswer: 1
    },
    {
      question: "Որ ամսին է դա Գաման հասել Հնդկաստան 1498 թվականին?",
      options: ["Մարտ", "Ապրիլ", "Մայիս", "Հունիս"],
      correctAnswer: 2
    },
    {
      question: "Ինչ կոչում ստացավ դա Գաման իր հաջողությունների համար?",
      options: ["Դուքս", "Կոմս", "Հնդկաստանի փոխարքա", "Ադմիրալ"],
      correctAnswer: 2
    },
    {
      question: "Որտեղ մահացավ Վասկո դա Գաման?",
      options: ["Լիսաբոն", "Մոմբասա", "Կոչին", "Գոա"],
      correctAnswer: 2
    },
    {
      question: "Քանի ճամփորդություն կատարեց դա Գաման դեպի Հնդկաստան?",
      options: ["1", "2", "3", "4"],
      correctAnswer: 2
    },
    {
      question: "Ինչ էր դա Գամայի հոր անունը?",
      options: ["Էշտևան դա Գամա", "Մանուել դա Գամա", "Պեդրո դա Գամա", "Ֆերնանդո դա Գամա"],
      correctAnswer: 0
    },
    {
      question: "Որ թագավորը հանձնարարեց դա Գամային ճամփորդել դեպի Հնդկաստան?",
      options: ["Ժուան II", "Մանուել I", "Ֆելիպե II", "Ալֆոնսո V"],
      correctAnswer: 1
    },
    {
      question: "Ինչպիսի հիվանդությունից տուժեց անձնակազմի մեծ մասը?",
      options: ["Մալարիա", "Տիֆ", "Ծնոտ (սկորբուտ)", "Դիզենտերիա"],
      correctAnswer: 2
    },
    {
      question: "Որ ժամանակաշրջանի մասն էր Վասկո դա Գաման?",
      options: ["Վերածննդի դարաշրջան", "Միջին դարեր", "Ուղեծրահայտության դարաշրջան", "Լուսավորության դարաշրջան"],
      correctAnswer: 2
    },
    {
      question: "Որ օվկիանոսը հատեց դա Գաման դեպի Հնդկաստան ճանապարհին?",
      options: ["Ատլանտյան", "Խաղաղ", "Հնդկական", "Արկտիկական"],
      correctAnswer: 2
    },
    {
      question: "Ինչ նպատակ ուներ Պորտուգալիան՝ ուղարկելով դա Գամային Հնդկաստան?",
      options: ["Նվաճել նոր տարածքներ", "Գտնել ուղղակի առևտրային ճանապարհ", "Քարոզել քրիստոնեությունը", "Ուսումնասիրել աշխարհագրությունը"],
      correctAnswer: 1
    }
  ];
